...
export const UI_TRANSLATIONS = {
  ru: {
    ...
    tagline: "Смысл видео — без лишнего",
    languageGroup: "Выбор языка",
    heroEyebrow: "Смотрите осознанно",
    heroTitle: "Поймите суть YouTube‑видео до просмотра",
    heroLead:
  ...
  en: {
    ...
    tagline: "The meaning without the noise",
    languageGroup: "Language selection",
    heroEyebrow: "Watch with purpose",
    heroTitle: "Understand a YouTube video before watching",
    heroLead:
  ...
  lv: {
    ...
    tagline: "Video jēga — bez liekā",
    languageGroup: "Valodas izvēle",
    heroEyebrow: "Skatieties apzināti",
    heroTitle: "Izprotiet YouTube video būtību pirms skatīšanās",
    heroLead:
...
export function detectPreferredLanguage({ storedLanguage, browserLanguages = [] } = {}) {
